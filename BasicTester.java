public class BasicTester{
	public static void main(String[]args){
		...
		System.out.println("Added 0-9 in order");
		//insert 0x - 9x before each value 0-9
		for(int i = 0; i < 10; i++){
			words.add(2*i,i+"x");
		}
		System.out.println("Inserted 0x-0x before each value 0-9");
		//check the head/tail add
		words.add(0,"head");
		words.add(words.size(),"tail");
		System.out.println("Checked the head/tail add");
		...
		System.out.println("About to extend");
		a.extend(b);
		System.out.println("A:"+a+a.size());
		System.out.println("B:"+b+b.size());
